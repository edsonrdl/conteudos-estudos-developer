# 📘 Guia Definitivo de Arquitetura e Fundamentos AWS: Do Core à Operação
...
- **1.1.1. Benefícios da computação em nuvem**
  - 1.1.1.1. Economia de escala
  - 1.1.1.2. Agilidade e velocidade
  - 1.1.1.3. Elasticidade e escalabilidade
  - 1.1.1.4. Alta disponibilidade e tolerância a falhas
- **1.1.2. Modelo de despesas (CapEx vs OpEx)**
- **1.1.3. Princípios de design da AWS Well-Architected Framework**
  - 1.1.3.1. Excelência operacional
  - 1.1.3.2. Segurança
  - 1.1.3.3. Confiabilidade
  - 1.1.3.4. Eficiência de performance
  - 1.1.3.5. Otimização de custos
  - 1.1.3.6. Sustentabilidade

### 1.2 Identificar aspectos da economia da nuvem
- 1.2.1. Modelo de precificação Pay-as-you-go
- 1.2.2. Total Cost of Ownership (TCO)
- 1.2.3. Calculadoras de custos AWS
- 1.2.4. Conceito de Right Sizing
- 1.2.5. Benefícios da automação

### 1.3 Explicar os diferentes princípios de design de nuvem
- 1.3.1. Design para falhas
- 1.3.2. Desacoplamento de componentes
- 1.3.3. Implementação de elasticidade
- 1.3.4. Paralelização
...
- 2.1.1. Responsabilidades da AWS (segurança DA nuvem)
- 2.1.2. Responsabilidades do cliente (segurança NA nuvem)
- 2.1.3. Controles herdados, compartilhados e do cliente

### 2.2 Conceitos de segurança e conformidade na nuvem
- 2.2.1. AWS Compliance Programs
- 2.2.2. AWS Artifact
- **2.2.3. Princípios de segurança**
  - 2.2.3.1. Princípio do menor privilégio
  - 2.2.3.2. Defense in depth
  - 2.2.3.3. Segregação de funções
...
- 2.4.1. AWS Trusted Advisor
- 2.4.2. AWS Security Center
- 2.4.3. AWS Well-Architected Tool
...
## 4 Domínio: Faturamento, Preços e Suporte (13%)
...
- **4.1.2. Modelos de preços de armazenamento**
- **4.1.3. Preços de transferência de dados**
- **4.1.4. AWS Free Tier (tipos e limites)**

### 4.2 Recursos de gerenciamento de custos
- 4.2.1. AWS Budgets
- 4.2.2. AWS Cost Explorer
- 4.2.3. AWS Cost and Usage Report
- 4.2.4. AWS Billing Dashboard
- 4.2.5. Tags para alocação de custos
- 4.2.6. Consolidated Billing
...
- 4.4.1. AWS Documentation
- 4.4.2. AWS Whitepapers
- 4.4.3. AWS Knowledge Center
- 4.4.4. AWS re:Post
- 4.4.5. AWS Professional Services
- 4.4.6. AWS Partner Network (APN)
- 4.4.7. AWS Marketplace